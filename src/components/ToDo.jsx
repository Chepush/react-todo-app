...
export const ToDo = () => {
    const [todos, setTodos] = useState([
        {id: 1, name: 'Todo 1', description: 'This is Todo 1\'s description', date: new Date().toLocaleString().slice(0,17).replace(/\//g,'.').replace(/,/g, ' -'), checked: false},
        {id: 2, name: 'Todo 2', description: 'This is Todo 2\'s description', date: new Date().toLocaleString().slice(0,17).replace(/\//g,'.').replace(/,/g, ' -'),  checked: false}
    ]);
    ...
    return (
        <Card title={'My todo list (Unchecked:' + countUnchecked() + ')'}>
